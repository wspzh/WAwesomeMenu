...
static CGFloat const kAwesomeMenuDefaultMenuWholeAngle = M_PI;// M_PI ;//* 2;
static CGFloat const kAwesomeMenuDefaultExpandRotation = M_PI;
static CGFloat const kAwesomeMenuDefaultCloseRotation = M_PI;//M_PI ;//* 2;
...
@implementation WAwesomeMenu
{
    NSArray *_menusArray;
    NSUInteger _flag;
    NSTimer *_timer;
    WAwesomeMenuItem *_startButton;
    
    id<WAwesomeMenuDelegate> __weak _delegate;
    BOOL _isAnimating;
}
...
- (void)AwesomeMenuItemTouchesEnd:(WAwesomeMenuItem *)item
{
    ...
    {
        WAwesomeMenuItem *otherItem = [_menusArray objectAtIndex:i];
...
- (void)_setMenu {
    ...
    {
        WAwesomeMenuItem *item = [_menusArray objectAtIndex:i];
        item.tag = 1000 + i;
...
- (void)_expand
{
    ...
    WAwesomeMenuItem *item = (WAwesomeMenuItem *)[self viewWithTag:tag];
